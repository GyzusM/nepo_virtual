    ...
    <>
      ...
      <div className='nepo'>
        ...
        <div className='quadrant-2'>
          ...
          <div className='column-1'>
            <Grano onClick={event => {counterLogic(event)}} yellow r1 className='redUp rUp1' />
            <Grano onClick={event => {counterLogic(event)}} yellow r2 className='redUp rUp2' />
            <Grano onClick={event => {counterLogic(event)}} yellow r3 className='redUp rUp3' />
          </div>
          <div className='column-2'>
            <Grano onClick={event => {counterLogic(event)}} blue r1 className='redUp rUp4' />
            <Grano onClick={event => {counterLogic(event)}} blue r2 className='redUp rUp5' />
            <Grano onClick={event => {counterLogic(event)}} blue r3 className='redUp rUp6' />
          </div>
          <div className='column-3'>
            <Grano onClick={event => {counterLogic(event)}} green r1 className='redUp rUp7' />
            <Grano onClick={event => {counterLogic(event)}} green r2 className='redUp rUp8' />
            <Grano onClick={event => {counterLogic(event)}} green r3 className='redUp rUp9' />
          </div>
        </div>
        <div className='quadrant-2'>

          <div className='column-1'>
            <Grano onClick={event => {counterLogic(event)}} yellow r1 className='yellowUp greenUp1' />
            <Grano onClick={event => {counterLogic(event)}} yellow r2 className='yellowUp greenUp2' />
            <Grano onClick={event => {counterLogic(event)}} yellow r3 className='yellowUp greenUp3' />
          </div>
          <div className='column-2'>
          ...
          <div className='column-3'>
            <Grano onClick={event => {counterLogic(event)}} green r1 className='greenUp greenUp7' />
            <Grano onClick={event => {counterLogic(event)}} green r2 className='greenUp greenUp8' />
            <Grano onClick={event => {counterLogic(event)}} green r3 className='greenUp greenUp9' />
          </div>
        </div>
