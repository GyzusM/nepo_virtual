...
import logoNepo from '../assets/img/logo_nepo.avif';
import jesus from '../assets/img/jesus.avif';
import estefania from '../assets/img/estefania.avif';
import gaspar from '../assets/img/gaspar.avif';
    ...
    {showMain === false ?
        ...
        <div className="contentHeader">
          ...
          <nav className="menu">
            <ul className={`column ${isOpen && "open"}`}>
              ...
              <li className="row">
                <button onClick={() => handleChangeLanguage("en")} className='btn-idioma'><img src={usa} alt='USA flag' width={32} height={32} /></button>
                <button onClick={() => handleChangeLanguage("es")} className='btn-idioma'><img src={mex} alt='MX flag'  width={32} height={32} /></button>
              </li>
            </ul>
        ...
        <div className={styles.contentAcercade}>
          ...
          <div className={styles.containerVideo}>
            <iframe 
              ...
              frameBorder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope;" allowFullScreen>
            </iframe>
      ...
      <section className={styles.comoseusa} id='comoseusa'>
        ...
        <div className={styles.row2}>
          ...
          <div className={styles.contentvideos}>
            ...
            <iframe slot='wrapper-start' width={460} height={215} src="https://www.youtube.com/embed/tWcTX4xKPqk" title="Video de resta con el Nepohualtzintzin" loading="lazy" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
      ...
      <section className={styles.contacto} id='contacto'>
        ...
        <div className={styles.contentForm}>
          <form action="https://formsubmit.co/nepohualtzintzin91@gmail.com" method="post" className="php-email-form" data-aos="fade-up" data-aos-delay="100">
            <div className={styles.rowForm1}>
            <input type="text" name="name" className="form-control" id="name" placeholder={t("contacto.input1")} data-rule="minlen:4" data-msg="Introduce al menos 4 caracteres."/>
            <input type="email" className="form-control" name="email" id="email" placeholder={t("contacto.input2")} data-rule="email" data-msg="Ingresa un correo valido."/>
            </div>
            <div className={styles.rowForm2}>
              <input type="text" className="form-control" name="phone" id="phone" placeholder={t("contacto.input3")} data-rule="minlen:4" data-msg="Introduce al menos 4 caracteres,"/>
            </div>
            <div className={styles.rowForm2}>
              <input type="text" className="form-control" name="message" id="mesagge" placeholder={t("contacto.input4")} data-rule="minlen:4" data-msg="Escribe un mensaje, recomendación o duda."/>
            </div>
          </form>
